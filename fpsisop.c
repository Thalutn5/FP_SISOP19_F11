...
void makeplaylist(){
    printf("Playlist_%d created", j);
    j=j+1;
}
void addsong(){
    int num;
    scanf("%d %s", &num, namalagu);
    strcpy(array[num][total[num]], namalagu);
    total[num]++;
}
void removesong(){
    int num;
    int i;
    scanf("%d %s", &num, namalagu);
    for(i=num;i<total[num];i++){
        strcpy(array[num][i], array[num][i+1]);
    }
    total[num]--;
}
void playlist(){
...
int main(){
    ...
    while(1){
        ...
        else if(strcmp(inputan, "makeplaylist")==0){
            makeplaylist();
        }
        else if(strcmp(inputan, "add")==0){
            addsong();
        }
        else if(strcmp(inputan, "remove")==0){
            removesong();
        }
        else if(strcmp(inputan, "playlist")==0){
            playlist();
        }
    }
}
